    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 flex flex-col">
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          {/* 跳转到医院端链接 */}
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 mb-6 border border-white/20">
          ...
          <div className="bg-white rounded-[28px] p-6 shadow-2xl">
            ...
            {!isRegistering && (
              <div className="mt-4 rounded-2xl border border-indigo-100 bg-indigo-50 p-3 text-center">
                <p className="text-xs text-indigo-500">测试账号</p>
                <p className="mt-1 text-sm font-semibold text-indigo-700">
                  13700137000 / password123
                </p>
                <button
                  type="button"
                  onClick={useDemoAccount}
                  className="mt-2 text-sm font-bold text-indigo-600 underline underline-offset-4"
                >
                  使用患者测试账号
                </button>
              </div>
